...
const Clock: React.FC<ClockProps> = ({ 
  ...
  const containerClasses = fullscreen 
    ? "min-h-screen flex items-center justify-center bg-neutral-950 relative"
  ...
  const cityNameClasses = fullscreen
    ? "text-3xl md:text-4xl mb-6 text-primary-300 font-semibold"
    : "text-xl mb-4 text-primary-400 font-semibold";

  const dateClasses = fullscreen
    ? "text-xl md:text-2xl mt-6 text-primary-400 font-medium"
    : "text-base mt-4 text-primary-500 font-medium";
